...
const subNavigation = [
  { name: "Factory", href: "#", current: true },
  { name: "ERC20", href: "#", current: false },
  { name: "Waiting List", href: "#", current: false },
  { name: "Dutch Auction", href: "#", current: false },
  { name: "Corporate Actions", href: "#", current: false },
  { name: "Helper", href: "#", current: false },
